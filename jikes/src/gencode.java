...
class gencode
{
    ...
    static public void main(String args[]) throws java.io.FileNotFoundException, java.io.IOException
    {
        ...
        if (LOG_BASE_SIZE > 0 && LOG_BASE_SIZE < 16)
        {
            ...
            hfile.println();
            hfile.println("#ifdef EBCDIC");
            hfile.println("    static char to_ascii[256];");
            hfile.println("    static char to_ebcdic[256];");
            hfile.println("#endif");
            hfile.println();
            ...
            hfile.println();
            hfile.println("#ifdef EBCDIC");
            hfile.println("    static inline char ToASCII(char c)         { return to_ascii[c]; }");
            hfile.println("    static inline char ToEBCDIC(char c)        { return to_ebcdic[c]; }");
            hfile.println("#endif");
            hfile.println();
            hfile.println("};");
            hfile.println();
